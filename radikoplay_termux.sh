...
# For Termux API #
##################
selected_station_name="$(termux-dialog spinner -t "放送局を選択" -v "HBCラジオ,STVラジオ,AIR-G'（FM北海道）,FM NORTH WAVE,RAB青森放送,エフエム青森,IBCラジオ,エフエム岩手,TBCラジオ,Date fm エフエム仙台,ABSラジオ,エフエム秋田,YBC山形放送,Rhythm Station　エフエム山形,RFCラジオ福島,ふくしまFM,NHKラジオ第1（札幌）,NHKラジオ第1（仙台）,TBSラジオ,文化放送,ニッポン放送,interfm,TOKYO FM,J-WAVE,ラジオ日本,BAYFM78,NACK5,ＦＭヨコハマ,LuckyFM 茨城放送,CRT栃木放送,RADIO BERRY,FM GUNMA,NHKラジオ第1（東京）,BSNラジオ,FM NIIGATA,KNBラジオ,FMとやま,MROラジオ,エフエム石川,FBCラジオ,FM福井,YBSラジオ,FM FUJI,SBCラジオ,FM長野,NHKラジオ第1（名古屋）,CBCラジオ,TOKAI RADIO,ぎふチャン,ZIP-FM,FM AICHI,FMGIFU,SBSラジオ,K-MIX,レディオキューブ FM三重,ABCラジオ,MBSラジオ,OBCラジオ大阪,FM COCOLO,FM802,FM大阪,Kiss FM KOBE,ラジオ関西,e-radio FM滋賀,KBS京都ラジオ,α-STATION FM KYOTO,WBS和歌山放送,NHKラジオ第1（大阪）,BSSラジオ,エフエム山陰,RSKラジオ,FM岡山,RCCラジオ,広島FM,KRY山口放送,エフエム山口,JRT四国放送,FM徳島,RNC西日本放送,エフエム香川,RNB南海放送,FM愛媛,RKC高知放送,エフエム高知,NHKラジオ第1（広島）,NHKラジオ第1（松山）,RKBラジオ,KBCラジオ,LOVE FM,CROSS FM,FM FUKUOKA,エフエム佐賀,NBCラジオ,FM長崎,RKKラジオ,FMKエフエム熊本,OBSラジオ,エフエム大分,宮崎放送,エフエム宮崎,MBCラジオ,μＦＭ,RBCiラジオ,ラジオ沖縄,FM沖縄,NHKラジオ第1（福岡）,ラジオNIKKEI第1,ラジオNIKKEI第2,NHK-FM（東京）" | jq '.text' -r)"
...
station_name=${selected_station_name} # 外部入力(放送局名を受け取る)
